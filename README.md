...
- A separate **c. 1300 research collection**, built country by country. The current set contains 58 researched c. 1300 European cards, now extending from Iberia into France, Brittany, Burgundy, English Aquitaine, Majorca, the imperial Rhône cities and Angevin Provence.
...
- `src/data1300.js`: researched c. 1300 card catalogue, currently 58 European cards with exact-year political ownership.
