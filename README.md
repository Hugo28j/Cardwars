...
- A separate **c. 1300 research collection**, built country by country. The current set contains 147 researched c. 1300 European cards, extending across Iberia, France, the Low Countries, Germany, the Alpine duchies, Bohemia, Moravia and the early Swiss Waldstätte.
...
- `src/data1300.js`: researched c. 1300 card catalogue, currently 147 European cards with exact-year political ownership.
