...
`assets/modern-atlas.json` derives from Natural Earth's 1:50m Admin 0 countries dataset:

- https://github.com/nvkelso/natural-earth-vector/blob/master/geojson/ne_50m_admin_0_countries.geojson
- https://www.naturalearthdata.com/about/terms-of-use/

Natural Earth data is public domain. Geometry is simplified, projected to the game's SVG coordinates and clipped by the map viewport. Modern boundaries are provided for orientation, not as historical borders.
...
Modern flag SVGs are bundled from https://flagcdn.com/ via the country flag artwork service at https://flagpedia.net/download/api. They are visual references for modern countries, not sixth-century banners.
