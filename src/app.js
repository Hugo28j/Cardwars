import {PLAYER_REALM, DIP_ACTIONS, diplomacyState, relation, opinion, attitude, acceptance, performAction, weeklyDiplomacy, relationSlots, availableCasusBelli1300} from './diplomacy1300.js?v=20260926-peace-siege-v22';
...
import {WorldMap} from './map.js?v=20260926-siege-army-colors-v12';
...
function campaignForeignMilitaryByCity1300(game){
...
function openDiplomacyAction1300(action){
 ...
 if(action==='gift'){
  ...
  const descriptions={
   ...
   peace:'Negotiate land, independence and Florin terms to end the war.',
