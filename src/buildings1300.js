...
export const BUILDINGS_1300=[
 {
  id:'fields',name:'Manorial Fields',category:'Food',cost:50,maxWorkers:1600,normalWage:0.06,monthlyRevenue:3.0,
  description:'Expand cultivated land, drainage and crop rotation around the city.',
  effects:{}
 },
 {
  id:'pastures',name:'Sheep Pastures',category:'Food / Production',cost:65,maxWorkers:1100,normalWage:0.06,monthlyRevenue:3.4,
  description:'Organised grazing grounds supply meat, wool and hides to local workshops.',
  effects:{economy:1}
 },
 {
  id:'textiles',name:'Textile Workshop',category:'Production',cost:90,maxWorkers:750,normalWage:0.06,monthlyRevenue:5.5,
  description:'Urban looms turn wool and flax into higher-value cloth for local and export markets.',
  effects:{economy:4}
 },
 {
  id:'forge',name:'Weapons Forge',category:'Military / Production',cost:115,maxWorkers:480,normalWage:0.06,monthlyRevenue:5.8,
  description:'Smiths produce arms, armour and tools while improving military supply.',
  effects:{}
 },
 {
  id:'market',name:'Market Hall',category:'Trade',cost:135,maxWorkers:520,normalWage:0.06,monthlyRevenue:6.5,
  description:'A regulated central market raises trade volume, tolls and commercial stability.',
  effects:{economy:3,stability:1}
 },
 {
  id:'barracks',name:'Professional Barracks',category:'Army',cost:165,maxWorkers:380,normalWage:0.06,monthlyRevenue:1.0,
 ...
 {
  id:'dockyard',name:'Royal Dockyard',category:'Navy',cost:200,requiresCoast:true,maxWorkers:560,normalWage:0.06,monthlyRevenue:4.0,
 ...
 {
  id:'walls',name:'Stone Fortifications',category:'Defence',cost:230,maxLevel:4,maxWorkers:260,normalWage:0.06,monthlyRevenue:0,
 ...
 {
  id:'guildhall',name:'Guild Hall',category:'Civic / Production',cost:270,maxWorkers:340,normalWage:0.06,monthlyRevenue:5.5,
 ...
 {
  id:'university',name:'University & Scriptorium',category:'Knowledge',cost:300,maxWorkers:220,normalWage:0.06,monthlyRevenue:2.5,
 ...
 ,
 {
  id:'watermill',name:'Watermill',category:'Food / Production',cost:80,maxWorkers:260,normalWage:0.06,monthlyRevenue:4.2,
  description:'River-driven mills grind grain faster and support bakers, brewers and urban food supply.',
  effects:{economy:1}
 },
 {
  id:'brewery',name:'Brewery & Tavern',category:'Food / Urban',cost:85,maxWorkers:300,normalWage:0.06,monthlyRevenue:4.4,
  description:'Brewers turn grain into beer while taverns create a dependable urban market.',
  effects:{economy:2,stability:1}
 },
 {
  id:'tannery',name:'Tannery',category:'Production',cost:95,maxWorkers:360,normalWage:0.06,monthlyRevenue:5.0,
  description:'Tanners process hides into leather for shoes, harnesses, armour fittings and export.',
  effects:{economy:3}
 },
 {
  id:'fishery',name:'Fishing Wharf',category:'Food / Maritime',cost:90,requiresCoast:true,maxWorkers:500,normalWage:0.06,monthlyRevenue:4.8,
  description:'Wharves, boats and curing sheds expand coastal fishing and preserved-food trade.',
  effects:{economy:1}
 },
 {
  id:'saltworks',name:'Saltworks',category:'Resource / Trade',cost:120,maxWorkers:420,normalWage:0.06,monthlyRevenue:6.4,
  description:'Salt pans, brine works and salt depots supply food preservation and long-distance trade.',
  effects:{economy:4}
 },
 {
  id:'quarry',name:'Stone Quarry',category:'Resource',cost:105,maxWorkers:650,normalWage:0.06,monthlyRevenue:4.7,
  description:'Organised quarrying supplies stone for walls, churches, bridges and urban construction.',
  effects:{economy:2,stability:1}
 },
 {
  id:'lumberyard',name:'Timber Yard',category:'Resource',cost:90,maxWorkers:700,normalWage:0.06,monthlyRevenue:4.3,
  description:'Managed timber cutting and storage support construction, carts, barrels and ships.',
  effects:{economy:2}
 },
 {
  id:'ironworks',name:'Ironworks',category:'Resource / Production',cost:135,maxWorkers:620,normalWage:0.06,monthlyRevenue:5.4,
  description:'Tool-equipped iron workers expand extraction, smelting and processing to supply usable iron.',
  effects:{economy:2}
 },
 {
  id:'mint',name:'Royal Mint',category:'Finance / Administration',cost:220,maxWorkers:160,normalWage:0.06,monthlyRevenue:7.0,
 ...
 {
  id:'monastery',name:'Monastery',category:'Clergy / Knowledge',cost:160,maxWorkers:280,normalWage:0.06,monthlyRevenue:2.4,
 ...
 {
  id:'cathedral',name:'Cathedral Chapter',category:'Clergy / Civic',cost:240,maxWorkers:240,normalWage:0.06,monthlyRevenue:2.8,
 ...
 {
  id:'hospital',name:'Hospital & Hospice',category:'Civic / Welfare',cost:150,maxWorkers:220,normalWage:0.06,monthlyRevenue:1.6,
