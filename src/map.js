...
const cityBorderColor=realm=>realm==='Crown of Castile'?'#69756f':mixHex(colorForRealm(realm),'#202b27',.68);
const cityBorderOpacity=realm=>realm==='Crown of Castile'?'.60':'.72';
const cache={};
