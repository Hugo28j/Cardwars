...
export class WorldMap{
 constructor(host,state,onSelect,onRegion){
  this.host=host;this.state=state;this.onSelect=onSelect;this.onRegion=onRegion;this.mode='historical';this.view={x:100,y:220,w:750,h:600};this.pointers=new Map();this.destroyed=false;this.drawn=false;this.coastMarkerCache=new Map();this.physicalLandPolys=[];this.deferredRefreshTimer=null;this.interactionRefreshDelay=90;
